...
namespace SistemaLaObra
{
    public class Articulo
    {
        ...
        private string _codigoDescripcion;
        ...
        private int _codigoUnidadesDeMedida;
        ...
        public int CodigoUnidadesDeMedida
        {
            get
            {
                return _codigoUnidadesDeMedida;
            }

            set
            {
                _codigoUnidadesDeMedida = value;
            }
        }
